...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState: GameState):
        ...
        def minimax(state, agentIndex, depth):
            ...
            def next_agent_depth(agentIndex, depth):
            ...
            if agentIndex == 0:
                ...
                for action in legalActions:
                    ...
                    nextAgent, nextDepth = next_agent_depth(agentIndex, depth)
        ...
        # best action for Pacman (agent 0)
        bestAction = None
        bestValue = float('-inf')
        ...
        for action in legalActions:
            ...
            # after Pacman, next is agent 1 (first ghost)
            nextAgent = 1 % numAgents
            depth = 0
            if nextAgent == 0:
                # corner case if there are no ghosts
                depth = 1
            value = minimax(successor, nextAgent, depth)
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState: GameState):
        ...
        for action in legalActions:
            ...
            if nextAgent == 0:  # corner case: no ghosts
                depth = 1

            value = alphabeta(successor, nextAgent, depth, alpha, beta)
